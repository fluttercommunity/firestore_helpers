...
main() {
  ...
  test("Distance Test3", () {
    var distance = distanceInKilometers(new GeoPoint(50.73743, 7.0982068),
        new GeoPoint(50.683861199999996, 7.1491171));
    print(distance);
  ...
  test("Distance2 Test3", () {
    var distance = distanceInKilometers2(new GeoPoint(50.73743, 7.0982068),
        new GeoPoint(50.683861199999996, 7.1491171));
    print(distance);
